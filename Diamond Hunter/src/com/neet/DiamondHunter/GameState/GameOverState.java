...
public class GameOverState extends GameState {
	...
	public void draw(Graphics2D g) {
		...
		if(rank == 1) Content.drawString(g, "Kazuma", 20, 78);
		else if(rank == 2) Content.drawString(g, "Darkness", 24, 78);
		else if(rank == 3) Content.drawString(g, "Megumin", 32, 78);
		else if(rank == 4) Content.drawString(g, "Aqua", 8, 78);

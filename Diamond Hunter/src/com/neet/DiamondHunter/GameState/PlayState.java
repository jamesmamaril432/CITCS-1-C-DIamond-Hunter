...
public class PlayState extends GameState {
	...
	public void init() {
		...
		// load music
		JukeBox.load("/Music/dokidoki.mp3", "music1");
		JukeBox.setVolume("music1", -10);
		JukeBox.loop("music1", 1000, 1000, JukeBox.getFrames("music1") - 1000);
		JukeBox.load("/Music/Awaken.mp3", "finish");
		JukeBox.setVolume("finish", -10);
		
		// load sfx
		JukeBox.load("/SFX/collect.wav", "collect");
		JukeBox.load("/SFX/time-resumes.mp3", "mapmove");
		JukeBox.load("/SFX/oraora.mp3", "tilechange");
		JukeBox.load("/SFX/splash.wav", "splash");
		JukeBox.load("/SFX/zawarudo.mp3", "pause");
